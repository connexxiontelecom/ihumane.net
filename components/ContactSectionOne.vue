                ...
                <div class="col">
                    ...
                    <div class="contact-Information mr-xl-7">
                        ...
                        <div class="section-title-two">
                            <span class="sub-title">Get in touch with our team of professionals today</span>
                            <h3 class="title">Want to learn how IHUMANE can help your organization?</h3>
                        </div>
                        ...
                        <div class="contact-info ct-info-two" data-vivus-hover>
                            ...
                            <div class="info">
                                ...
                                <span class="info-text">2A Iller Crescent, Maitama, Abuja</span>
                            </div>
                        </div>
                        ...
                        <div class="contact-info ct-info-two" data-vivus-hover>
                            ...
                            <div class="info">
                                ...
                                <span class="info-text"> (+234) 901-640-0000</span>
                            </div>
                        </div>
                        <!-- Contact Info Item End -->
                        ...
                        <div class="contact-info ct-info-two" data-vivus-hover>
                            ...
                            <div class="info">
                                ...
                                <span class="info-text">
                                    <a href="mailto:info@ihumane.net">info@ihumane.net</a>,
                                    <a href="mailto:info@connexxiontelecom.com">info@connexxiontelecom.com</a>
                                </span>
                            </div>
                        </div>
                        <!-- Contact Info Item End -->
                ...
                <div class="col">
                    ...
                    <div class="contact-form-area box-shadow">
                        ...
                        <div class="section-title text-center mb-7">
                            <h2 class="title fz-28">Let’s talk about your company</h2>
                            <p class="sub-title">We have made it easy for clients to reach us and get their solutions started</p>
                        </div>
                        <!-- Section Title End -->
                        <form >
                            <div class="row mb-n4">
                                ...
                                <div class="col-12 text-center mb-4">
                                    <button type="button" class="btn btn-primary btn-hover-secondary">Get in touch today</button>
                                </div>
                            </div>
                        </form>
