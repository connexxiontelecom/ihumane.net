                ...
                <div class="row justify-content-between align-items-center">
                    ...
                    <div class="col-xl-2 col-auto order-0">
                        <div class="header-logo">
                            <n-link to="/">
                                <img class="dark-logo" src="/images/logo/ihumane-green-long.svg" alt="Agency Logo">
                    ...
                    <div class="col-auto col-xl d-flex align-items-center justify-content-xl-end justify-content-end order-2 order-xl-1">
                        <div class="menu-column-area d-none d-xl-block position-static">
                            <Navigation />
                        </div>
                        <!-- Header Search Start -->
<!--                        <div class="header-search-area">-->
<!--                            &lt;!&ndash; Header Login Start &ndash;&gt;-->
...
<!--                        </div>-->
                    ...
                    <div class="col-xl-2 col d-none d-sm-flex justify-content-end order-1 order-xl-2">
                        <n-link to="/" class="btn btn-light btn-hover-primary">Sign In</n-link>
                    </div>
                    <!-- Header Right End -->
...
<script>
    export default {
        components: {
            Navigation: () => import("@/components/MainNavigation"),
        },
